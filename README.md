...
- **Interactivity**: Tap or click different parts of the bunny on the start screen for fun reactions!
- **Replay Value**: Store your best scores and coins between sessions using built-in text storage.

🚀 **2. How to Run the Game**
1) Ensure that the folders `images` and `sounds` are located in the same directory as `HungryBunny.py`.
2) Run the game by executing the `HungryBunny.py` file in your Python environment.
3) No setup beyond Python + `cmu_graphics` is required.
